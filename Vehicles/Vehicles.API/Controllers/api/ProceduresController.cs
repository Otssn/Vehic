...
namespace Vehicles.API.Controllers.api
{
    ...
    public class ProceduresController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Procedures>> GetProcedure(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutProcedure(int id, Procedures procedure)
        {
            if (id != procedure.Id)
            {
                return BadRequest();
        ...
        [HttpPost]
        public async Task<ActionResult<Procedures>> PostProcedure(Procedures procedure)
        {
